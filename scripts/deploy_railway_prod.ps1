...
$backendAllow = @(
    ...
    "QDRANT_API_KEY",
    "NIM_BASE_URL","NIM_API_KEY","EMBED_MODEL","EMBED_VECTOR_SIZE","EMBED_TIMEOUT_SECONDS",
    "GITHUB_CLIENT_ID","GITHUB_CLIENT_SECRET","GITHUB_OAUTH_REDIRECT_URI","FRONTEND_URL",
    "NEMOTRON_MODEL","OPENROUTER_API_KEY","GROQ_API_KEY","JWT_SECRET","JWT_ACCESS_TTL_MINUTES","JWT_REFRESH_TTL_DAYS",
    "LLM_CHAT_MODEL","LLM_FALLBACK_MODEL","LLM_PRIMARY_PROVIDER","LLM_FALLBACK_PROVIDER",
    "LLM_PRIMARY_TIMEOUT_SECONDS","LLM_FALLBACK_TIMEOUT_SECONDS","OPENROUTER_BASE_URL","GROQ_BASE_URL",
    "SHARE_TOKEN_TTL_DAYS","RATE_LIMIT_WINDOW_SECONDS","RATE_LIMIT_GUEST_PER_WINDOW","RATE_LIMIT_AUTH_PER_WINDOW",
    "RERANKER_ENABLED","RERANKER_MODEL","RERANKER_CANDIDATE_LIMIT",
    "R2_BUCKET","R2_ACCESS_KEY","R2_SECRET_KEY"
)

$workerAllow = @(
    "ENV","REDIS_URL","DATABASE_URL","QDRANT_URL","QDRANT_COLLECTION","QDRANT_API_KEY",
    "NIM_BASE_URL","NIM_API_KEY","EMBED_MODEL",
    "PARSE_CLONE_TIMEOUT_SECONDS","PARSE_MAX_FILES","PARSE_MAX_CHUNKS","PARSE_CHUNK_LINES","PARSE_CHUNK_OVERLAP_LINES",
    "EMBED_VECTOR_SIZE","EMBED_TIMEOUT_SECONDS","EMBED_BATCH_SIZE","EMBED_RETRY_ATTEMPTS","EMBED_CACHE_TTL_SECONDS",
    "WORKER_RETRY_MAX_ATTEMPTS","WORKER_RETRY_BASE_DELAY_SECONDS","WORKER_METRICS_PORT",
    "LLM_SUMMARY_PROVIDER","LLM_PRIMARY_PROVIDER","LLM_FALLBACK_PROVIDER","LLM_SUMMARY_MODEL","LLM_FALLBACK_MODEL",
    "LLM_SUMMARY_TIMEOUT_SECONDS","LLM_PRIMARY_TIMEOUT_SECONDS","LLM_FALLBACK_TIMEOUT_SECONDS",
    "OPENROUTER_API_KEY","OPENROUTER_BASE_URL","GROQ_API_KEY","GROQ_BASE_URL"
)
